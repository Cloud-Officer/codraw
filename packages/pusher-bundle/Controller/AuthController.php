...
namespace Draw\Bundle\PusherBundle\Controller;
...
class AuthController
{
    ...
    private function genSharedSecret(string $channel): string
    {
        ...
        return hash('sha256', $channel.base64_decode($this->configuration->getOptions()['encryption_master_key_base64'], true), true);
    }
}
